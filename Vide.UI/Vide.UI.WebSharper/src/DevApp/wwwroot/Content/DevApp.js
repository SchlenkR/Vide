...
{
 "use strict";
 var Vide,WebSharper,Client,EventTarget,Node,WindowOrWorkerGlobalScope,WebSharper$1,Obj,Runtime;
 Vide=Global.Vide=Global.Vide||{};
 WebSharper=Vide.UI.WebSharper=Vide.UI.WebSharper||{};
 ...
 Runtime=WebSharper$1&&WebSharper$1.Runtime;
 Client.Main=function()
 {
  self.document.getElementById("main");
 };
 Obj=WebSharper$1.Obj=Runtime.Class({},null,Obj);

...
NOTE ABOUT THIS FILE:
   ...
   the styles are stored using resource ids (Vide.Maui.Resources.Styles.XXX.xaml) so Maui uses XamlResourceId
   ...
   - Add a class name inside the XAML (<ResourceDictionary x:Class="Vide.Maui.XXX">)
   - Create a new type in this file:
    ...
    - Register the XAML file and this type by adding a XamlResourceId attribute below
        - ResourceId must follow format: Namespace.Folder.SubFolder.FileName.Extension (Vide.Maui.Resources.Styles.XXX.xaml)
...
[<XamlResourceId("Vide.Maui.Resources.Styles.Colors.xaml", "Resources/Styles/Colors.xaml", typeof<Colors>)>]
[<XamlResourceId("Vide.Maui.Resources.Styles.Styles.xaml", "Resources/Styles/Styles.xaml", typeof<Styles>)>]
do ()

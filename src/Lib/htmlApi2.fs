...
module HtmlElementBuilders =
    ...
    type html() =
        ...
        member this.className(value: System.String) = this.AddModifier(fun x -> x.setAttribute("class", value))
        ...
        member this.onabort(handler) = this.AddInitOnlyModifier(fun x -> x.onabort <- handler)
        member this.onblur(handler) = this.AddInitOnlyModifier(fun x -> x.onblur <- handler)
        member this.oncanplay(handler) = this.AddInitOnlyModifier(fun x -> x.oncanplay <- handler)
        member this.oncanplaythrough(handler) = this.AddInitOnlyModifier(fun x -> x.oncanplaythrough <- handler)
        member this.onchange(handler) = this.AddInitOnlyModifier(fun x -> x.onchange <- handler)
        member this.onclick(handler) = this.AddInitOnlyModifier(fun x -> x.onclick <- handler)
        member this.oncontextmenu(handler) = this.AddInitOnlyModifier(fun x -> x.oncontextmenu <- handler)
        member this.oncuechange(handler) = this.AddInitOnlyModifier(fun x -> x.oncuechange <- handler)
        member this.ondblclick(handler) = this.AddInitOnlyModifier(fun x -> x.ondblclick <- handler)
        member this.ondrag(handler) = this.AddInitOnlyModifier(fun x -> x.ondrag <- handler)
        member this.ondragend(handler) = this.AddInitOnlyModifier(fun x -> x.ondragend <- handler)
        member this.ondragenter(handler) = this.AddInitOnlyModifier(fun x -> x.ondragenter <- handler)
        member this.ondragleave(handler) = this.AddInitOnlyModifier(fun x -> x.ondragleave <- handler)
        member this.ondragover(handler) = this.AddInitOnlyModifier(fun x -> x.ondragover <- handler)
        member this.ondragstart(handler) = this.AddInitOnlyModifier(fun x -> x.ondragstart <- handler)
        member this.ondrop(handler) = this.AddInitOnlyModifier(fun x -> x.ondrop <- handler)
        member this.ondurationchange(handler) = this.AddInitOnlyModifier(fun x -> x.ondurationchange <- handler)
        member this.onemptied(handler) = this.AddInitOnlyModifier(fun x -> x.onemptied <- handler)
        member this.onended(handler) = this.AddInitOnlyModifier(fun x -> x.onended <- handler)
        member this.onerror(handler) = this.AddInitOnlyModifier(fun x -> x.onerror <- handler)
        member this.onfocus(handler) = this.AddInitOnlyModifier(fun x -> x.onfocus <- handler)
        member this.oninput(handler) = this.AddInitOnlyModifier(fun x -> x.oninput <- handler)
        member this.onkeydown(handler) = this.AddInitOnlyModifier(fun x -> x.onkeydown <- handler)
        member this.onkeypress(handler) = this.AddInitOnlyModifier(fun x -> x.onkeypress <- handler)
        member this.onkeyup(handler) = this.AddInitOnlyModifier(fun x -> x.onkeyup <- handler)
        member this.onload(handler) = this.AddInitOnlyModifier(fun x -> x.onload <- handler)
        member this.onloadeddata(handler) = this.AddInitOnlyModifier(fun x -> x.onloadeddata <- handler)
        member this.onloadedmetadata(handler) = this.AddInitOnlyModifier(fun x -> x.onloadedmetadata <- handler)
        member this.onloadstart(handler) = this.AddInitOnlyModifier(fun x -> x.onloadstart <- handler)
        member this.onmousedown(handler) = this.AddInitOnlyModifier(fun x -> x.onmousedown <- handler)
        member this.onmouseenter(handler) = this.AddInitOnlyModifier(fun x -> x.onmouseenter <- handler)
        member this.onmouseleave(handler) = this.AddInitOnlyModifier(fun x -> x.onmouseleave <- handler)
        member this.onmousemove(handler) = this.AddInitOnlyModifier(fun x -> x.onmousemove <- handler)
        member this.onmouseout(handler) = this.AddInitOnlyModifier(fun x -> x.onmouseout <- handler)
        member this.onmouseover(handler) = this.AddInitOnlyModifier(fun x -> x.onmouseover <- handler)
        member this.onmouseup(handler) = this.AddInitOnlyModifier(fun x -> x.onmouseup <- handler)
        member this.onmousewheel(handler) = this.AddInitOnlyModifier(fun x -> x.onmousewheel <- handler)
        member this.onpause(handler) = this.AddInitOnlyModifier(fun x -> x.onpause <- handler)
        member this.onplay(handler) = this.AddInitOnlyModifier(fun x -> x.onplay <- handler)
        member this.onplaying(handler) = this.AddInitOnlyModifier(fun x -> x.onplaying <- handler)
        member this.onprogress(handler) = this.AddInitOnlyModifier(fun x -> x.onprogress <- handler)
        member this.onratechange(handler) = this.AddInitOnlyModifier(fun x -> x.onratechange <- handler)
        member this.onreset(handler) = this.AddInitOnlyModifier(fun x -> x.onreset <- handler)
        member this.onscroll(handler) = this.AddInitOnlyModifier(fun x -> x.onscroll <- handler)
        member this.onseeked(handler) = this.AddInitOnlyModifier(fun x -> x.onseeked <- handler)
        member this.onseeking(handler) = this.AddInitOnlyModifier(fun x -> x.onseeking <- handler)
        member this.onselect(handler) = this.AddInitOnlyModifier(fun x -> x.onselect <- handler)
        member this.onstalled(handler) = this.AddInitOnlyModifier(fun x -> x.onstalled <- handler)
        member this.onsubmit(handler) = this.AddInitOnlyModifier(fun x -> x.onsubmit <- handler)
        member this.onsuspend(handler) = this.AddInitOnlyModifier(fun x -> x.onsuspend <- handler)
        member this.ontimeupdate(handler) = this.AddInitOnlyModifier(fun x -> x.ontimeupdate <- handler)
        member this.onvolumechange(handler) = this.AddInitOnlyModifier(fun x -> x.onvolumechange <- handler)
        member this.onwaiting(handler) = this.AddInitOnlyModifier(fun x -> x.onwaiting <- handler)
